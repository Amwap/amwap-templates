"""
Django settings for django4_template project.
...
ROOT_URLCONF = 'django4_template.urls'
...
WSGI_APPLICATION = 'django4_template.wsgi.application'
...
if env.db("DATABASE_URL"):
    DATABASES = {
            'default': env.db("DATABASE_URL") #postgres://django4_template_user:django4_template_pass@localhost:5432/django4_template_db
        }
