"""
Django settings for dajngo4_vue_template project.
...
ROOT_URLCONF = 'dajngo4_vue_template.urls'
...
WSGI_APPLICATION = 'dajngo4_vue_template.wsgi.application'
...
if env.db("DATABASE_URL"):
    DATABASES = {
            'default': env.db("DATABASE_URL") #postgres://dajngo4_vue_template_user:dajngo4_vue_template_pass@localhost:5432/dajngo4_vue_template_db
        }
